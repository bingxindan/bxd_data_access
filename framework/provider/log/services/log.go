...
import (
	...
	"github.com/bingxindan/bxd_data_access/framework/provider/log/formatter"
	"io"
	pkgLog "log"
	"time"
)
...
func (log *BxdLog) IsLevelEnable(level contract.LogLevel) bool {
	return level <= log.level
}

// logf 为打印日志的核心函数
func (log *BxdLog) logf(level contract.LogLevel, ctx context.Context, msg string, fields map[string]interface{}) error {
	// 先判断日志级别
