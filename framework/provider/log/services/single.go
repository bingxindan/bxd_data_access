...
// NewBxdSingleLog params sequence: level, ctxFielder, Formatter, map[string]interface(folder/file)
func NewBxdSingleLog(params ...interface{}) (interface{}, error) {
