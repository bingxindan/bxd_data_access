...
var newCommand = &cobra.Command{
	...
	RunE: func(c *cobra.Command, args []string) error {
		...
		fmt.Println("bxd框架版本：", release.GetTagName())

		templateFolder := filepath.Join(currentPath, "template-bxd-"+version+"-"+cast.ToString(time.Now().Unix()))
		...
		// 获取folder下的gohade-bxd-xxx相关解压目录
